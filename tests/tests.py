...
class Tests:
    ...
    def run(self):
        ...
        for joueur in self.tournoi.joueurs:
            print(joueur)
        print()
        # Affiche les infos des matchs du tour 2
        for match in tour_2.liste_matchs:
            print(match)
